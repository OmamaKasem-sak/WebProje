...
namespace WebProje.Areas.Admin.Controllers
{
    ...
    public class HomelandController : Controller
    {
        ...
        // GET: Admin/Homeland/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: Admin/Homeland/Create
